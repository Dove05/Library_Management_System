...
year.setModel(yearModel);
    ...
    private void initComponents() {
        ...
        getContentPane().add(confirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 470, 110, 50));
...
// Method to deposit funds into an existing account
    ...
    boolean success = writeDataToCSV(accountNumber, fullName, emailText, phoneText, addressText, birthDate, pinText);
...
private boolean isValidPhoneNumber(String phoneNumber) {
    ...
    private boolean writeDataToCSV(long accountNumber, String fullName, String email, String phone, String address, String birthDate, String pin) {
        try {
            File file = new File("accounts.csv");
            if (!file.exists()) {
                file.createNewFile();
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter(file, true));
            writer.write(accountNumber + "," + fullName + "," + email + "," + phone + "," + address + "," + birthDate + "," + pin);
            writer.newLine();
            writer.close();
            JOptionPane.showMessageDialog(null, "Account details saved successfully!");
